...
function LeftBAR({ storage }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "left-bar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "left-bar__logo", style: {
      paddingRight: "10px",
      height: "40px",
      width: "40px"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "left-bar__search", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { onKeyDown: (props) => evalueate(props), type: "text", placeholder: "Enter EAN" }) })
  ] });
}
function CenterBAR() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "center-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "title", children: "CD-Pusher" }) });
}
function RightBAR() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "right-bar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "right-bar__icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fas fa-user" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "right-bar__icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fas fa-bell" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "right-bar__icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fas fa-cog" }) })
  ] });
}
function Topbar(storage) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "topbar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(LeftBAR, { storage: storage.storage }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CenterBAR, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RightBAR, {})
  ] }) });
}
...
(function(module, exports) {
  (function(global2, factory) {
    ...
    function _assertClassBrand(e, t2, n2) {
      if ("function" == typeof e ? e === t2 : e.has(t2))
    ...
    var getFocusableElements = function getFocusableElements2() {
      ...
      var otherFocusableElementsFiltered = Array.from(otherFocusableElements).filter(function(el2) {
        return el2.getAttribute("tabindex") !== "-1";
      });
      return _toConsumableArray(new Set(focusableElementsWithTabindexSorted.concat(otherFocusableElementsFiltered))).filter(function(el2) {
        return isVisible$1(el2);
      });
    };
    ...
    var setStyle = function setStyle2(parent, selector, property, value) {
      var el2 = parent.querySelector(selector);
      if (el2) {
    ...
    renderInputType.textarea = function(textarea, params) {
      ...
      var getMargin = function getMargin2(el2) {
        return parseInt(window.getComputedStyle(el2).marginLeft) + parseInt(window.getComputedStyle(el2).marginRight);
      };
      setTimeout(function() {
    ...
    var keydownHandler = function keydownHandler2(innerParams, event2, dismissWith) {
      if (!innerParams) {
        return;
      }
      ...
      if (event2.key === "Enter") {
        ...
        handleTab(event2);
      } else if ([].concat(arrowKeysNextButton, arrowKeysPreviousButton).includes(event2.key)) {
        handleArrows(event2.key);
      } else if (event2.key === "Escape") {
        handleEsc(event2, innerParams, dismissWith);
      }
    };
    var handleEnter = function handleEnter2(event2, innerParams) {
    ...
    var handleTab = function handleTab2(event2) {
    ...
    var handleEsc = function handleEsc2(event2, innerParams, dismissWith) {
    ...
    var setAriaHidden = function setAriaHidden2() {
      ...
      bodyChildren.forEach(function(el2) {
    ...
    var lockBodyScroll = function lockBodyScroll2() {
      ...
      container.ontouchstart = function(event2) {
        preventTouchMove = shouldPreventTouchMove(event2);
      };
      container.ontouchmove = function(event2) {
        if (preventTouchMove) {
          event2.preventDefault();
          event2.stopPropagation();
        }
    ...
    var isStylus = function isStylus2(event2) {
    ...
    var bodyClickListener = function bodyClickListener2(event2) {
      for (var el2 = event2.target; el2 && el2 !== document; el2 = el2.parentNode) {
        for (var attr in clickHandlers) {
          var template = el2.getAttribute(attr);
          if (template) {
    ...
    var showWarningsForElements = function showWarningsForElements2(templateContent) {
      ...
      Array.from(templateContent.children).forEach(function(el2) {
    ...
    var showWarningsForAttributes = function showWarningsForAttributes2(el2, allowedAttributes) {
      Array.from(el2.attributes).forEach(function(attribute) {
    ...
    var swalOpenAnimationFinished = function swalOpenAnimationFinished2(event2) {
      var popup = getPopup();
      if (event2.target !== popup || !animationEndEvent) {
        return;
      }
      var container = getContainer();
...
function Popup({ song, storage, closePopup }) {
  const id2 = song.song_id;
  const index = storage.songs.findIndex((song2) => song2.song_id === id2);
  if (index === -1) {
  ...
  function resolveButton() {
    if (song.spotify_search && !song.spotify_missmatch) {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "popup__button", onClick: () => useDiscOGs(song, storage, closePopup), children: "Use DiscOGs" })
      ] });
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup__container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup__content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup__cover", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { height: "180px", src: song.song_cover_uri === null ? "/assets/images/svg/questionmark.svg" : song.song_cover_uri, width: "180px", alt: "Song Cover" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup__info", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup__separator", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup__row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup__upper", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "popup__title overflow", children: song.song_title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "overflow", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Album:" }),
              " ",
              song.song_album ? song.song_album : "Unbekannt"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup__lower", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "release_year", children: song.song_year ? song.song_year : "Unbekannt" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup__row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup__upper", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup__space-around", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup__lower", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "Interne CD Nummer: ",
            storage.discInfo.id
          ] }) })
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup__separator popup__half-height", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup__row", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup__upper", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "duration", children: Math.floor(song.song_duration / 60) + ":" + String.prototype.padStart.call(song.song_duration % 60, 2, "0") + " Minuten" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup__row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup__lower", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "composer", children: "Spotify State" }),
...
function Content({ storage }) {
  function testEans() {
    ...
    return eans.map((ean) => {
      ...
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { children: [
        ean,
        " - - - - Click to Fetch songs ",
        ean === "5 099920 596323" && "- Click to see what happens when the CD is not documented well enough",
        " "
      ] }) }, ean);
    });
  }
  ...
  reactExports.useEffect(() => {
    document.body.addEventListener("keydown", (event2) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content", children: [
    ...
    storage.songs && storage.songs.map((song) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className, onClick: () => openPopup(song), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "title__cover", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "song__title", children: song.song_title })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "song__artist", children: song.song_artists && song.song_artists.join("\n") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "song__album", children: song.song_album })
      ] }, song.song_id);
    })
  ] });
}
function Footer({ storage }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { children: "© 2024 RedReaperLp" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
      storage.webSocket.send(JSON.stringify({
        request: "clear-songs"
      }));
      storage.setSongs([]);
    }, children: "Clear Songs" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
      storage.webSocket.send(JSON.stringify({
        request: "push"
      }));
...
function App() {
  ...
  reactExports.useEffect(() => {
    ...
    function initializeWebSocket() {
      ...
      storage.webSocket.onmessage = (event2) => {
        ...
        switch (response.request) {
          ...
          case "song-response": {
            const id2 = curSongs.findIndex((song) => song.song_id === response.song.song_id);
            ...
            if (id2 !== -1) {
              storageRef.current.setSongs((prevSongs) => {
                ...
                updatedSongs[id2] = response.song;
                return updatedSongs;
              });
            } else {
            ...
            if (el2 && el2.childElementCount % 5 === 0)
              el2.lastChild.scrollIntoView({
                behavior: "smooth",
                block: "end",
                inline: "nearest"
              });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Topbar, { storage: storageRef.current }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Content, { storage: storageRef.current }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, { storage: storageRef.current })
  ] });
}
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Profiler, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) })
);
